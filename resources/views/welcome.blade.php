    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1">
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l" id="audioDiv">
                    <audio id="audioID" style="width: 100%;" controls autoplay loop>
                        <source src="https://usa19.fastcast4u.com:3870/;?type=http&nocache=1659423619"
                                type="audio/mpeg">
                    </audio>
                </div>
            </div>
